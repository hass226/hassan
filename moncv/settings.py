...
CLOUDINARY_STORAGE = {
    ...
    'MEDIA_TAG': 'media',
    'INVALID_VIDEO_ERROR_MESSAGE': 'Veuillez télécharger un fichier vidéo valide.',
    'EXCLUDE_DELETE_ORPHANED_MEDIA_PATHS': ('path/', 'secondpath/'),
    'STATICFILES_MANIFEST_ROOT': os.path.join(BASE_DIR, 'manifest'),
}

# Pour les fichiers médias (images, vidéos, etc.)
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')

# Pour les fichiers statiques (CSS, JavaScript, images)
STATIC_URL = '/static/'
